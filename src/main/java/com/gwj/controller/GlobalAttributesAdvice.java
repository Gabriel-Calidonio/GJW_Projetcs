...
public class GlobalAttributesAdvice {
    ...
    public Map<String, String> getEmpresaConfig() {
        ...
        // Se a rota for do assistente de setup, retorna imediatamente os valores padrão
        if (request != null && request.getRequestURI() != null && request.getRequestURI().startsWith("/setup")) {
            return configMap;
        }
