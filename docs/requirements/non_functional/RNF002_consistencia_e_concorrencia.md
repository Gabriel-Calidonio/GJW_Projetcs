...
1. **Unit of Work com `ThreadLocal`:**
   * A classe [`UnitOfWork.java`](/src/main/java/com/gwj/service/transaction/UnitOfWork.java) gerencia a conexão JDBC ativa associada à thread da requisição HTTP corrente.
