...
* **Serviço:** [`AgendamentoService.java`](/src/main/java/com/gwj/service/AgendamentoService.java) (`confirmarReserva`, `determinarProfissionalLivre`)
* **Transação:** [`UnitOfWork.java`](/src/main/java/com/gwj/service/transaction/UnitOfWork.java)
