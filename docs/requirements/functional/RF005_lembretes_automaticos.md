...
* **Serviços:** [`AgendamentoService.java`](/src/main/java/com/gwj/service/AgendamentoService.java)
* **Diagramas Relacionados:** [`envio_lembretes_automaticos.puml`](/docs/workflows/activity/envio_lembretes_automaticos.puml), [`sequenceDiagramNotificationJob.puml`](/docs/workflows/sequence/sequenceDiagramNotificationJob.puml)
